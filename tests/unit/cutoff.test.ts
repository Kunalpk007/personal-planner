...
import { pad, getDayKey, getPrevDayKey, getWeekMonday, getWeekDates, isWeekend, daysBetween, formatDate, formatDateShort } from '@/lib/engine/cutoff'
...
describe('getWeekDates', () => {
  it('returns all 7 dates of the week starting at the given Monday', () => {
    expect(getWeekDates('2024-01-01')).toEqual([
  ...
  it('handles a week that crosses a month boundary', () => {
    expect(getWeekDates('2024-01-29')).toEqual([
